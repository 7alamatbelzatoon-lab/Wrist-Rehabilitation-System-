...
class DoctorNode(Node):
    def __init__(self):
       ...
       # ]      
        #self.angle_sequence = [
         #   0.0, 5.0, 10.0, 15.0, 20.0, 25.0, 30.0, 35.0, 40.0, 45.0, 50.0, 55.0, 70.0, 55.0, 50.0, 45.0, 40.0, 35.0, 
         #   30.0, 25.0, 20.0, 15.0, 10.0, 5.0, 0.0
          #  ]
        #self.angle_sequence = [
        #    0.0, 5.0, 10.0, 15.0, 20.0, 25.0, 30.0, 35.0, 40.0, 45.0, 50.0, 55.0, 60.0, 65.0, 67.0, 67.0, 66.0, 66.0, 66.0, 64.0, 60.0, 60.0, 60.0, 60.0, 55.0, 50.0, 45.0, 40.0, 35.0, 
         #   30.0, 25.0, 20.0, 15.0, 10.0, 5.0, 0.0
        #]
        #self.angle_sequence = [
        #0.0, 5.0, 10.0, 15.0, 20.0, 25.0, 30.0, 35.0, 45.0, 50.0, 55.0, 60.0, 65.0, 75.0, 75.0, 60.0, 50.0, 50.0, 50.0, 50.0, 45.0, 50.0, 55.0, 60.0, 55.0, 50.0, 45.0, 40.0, 35.0, 30.0, 25.0, 20.0, 15.0, 10.0, 5.0, 0.0] #Test 2

        #self.angle_sequence = [
        #0.0, 5.0, 10.0, 15.0, 20.0, 25.0, 30.0, 35.0, 45.0, 50.0, 50.0, 55.0, 55.0, 50.0, 50.0, 45.0, 45.0, 40.0, 40.0, 35.0, 35.0, 30.0, 25.0, 20.0, 15.0, 10.0, 5.0, 0.0] #test 3

        self.angle_sequence = [
        0.0, 5.0, 10.0, 15.0, 20.0, 25.0, 30.0, 35.0, 45.0, 50.0, 45.0, 50.0, 45.0, 450.0, 50.0, 55.0, 45.0, 40.0, 35.0, 30.0, 25.0, 20.0, 15.0, 10.0, 5.0, 0.0]
